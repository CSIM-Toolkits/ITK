 ...
 *
 *=========================================================================*/
#ifndef __itkSampEn3DImageCalculator_hxx
#define __itkSampEn3DImageCalculator_hxx
...
SampEn3DImageCalculator< TInputImage >
...
::ComputeEntropy(void)
{
    ...
    double image_matrix[m_Nx*m_Ny*m_Nz];
    ...
    double den = (m_Nx - m_M) * (m_Ny - m_M) * (m_Nz - m_M);

    for (int yi = 0; yi < m_Ny - m_M; yi++) {
        for (int xi = 0; xi < m_Nx - m_M; xi++) {
//            for (int zi = 0; zi < m_Nz - m_M; zi++) {
//TODO Preparar metodo para 3D
//            }
...
template< typename TInputImage >
void SampEn3DImageCalculator< TInputImage >
::ParametersCertification()
{
